...
Ứng dụng kết hợp sức mạnh của công nghệ Blockchain (Ethereum/Solidity) và giao diện React hiện đại để đảm bảo tính minh bạch, bảo mật và trải nghiệm người dùng Real-time.
...
📖 Hướng dẫn sử dụng
Kết nối ví: Người dùng nhấn "Kết nối ví MetaMask" để đăng nhập. Hệ thống sẽ tự động nhận diện quyền Admin dựa trên địa chỉ ví.
